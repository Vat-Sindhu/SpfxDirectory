...
var PeopleList = /** @class */ (function (_super) {
    ...
    PeopleList.prototype.render = function () {
        var _this = this;
        return (React.createElement("div", { className: 'pnPPagination' },
                    ...
                    React.createElement("div", { className: 'row' },
                        React.createElement("div", { className: 'applygrid' }, this.state.paginatedItems.map(function (p, i) {
                            ...
                            return (React.createElement("div", { key: i, className: "persona_card" },
                                ...
                                React.createElement(Persona, { onClick: _this._onPersonaClicked(i, p), text: p.name, secondaryText: p.email, tertiaryText: p.mobile, imageUrl: '/_layouts/15/userphoto.aspx?size=S&accountname=' + p.email, imageAlt: p.name, size: PersonaSize.size72, styles: { primaryText: { fontSize: '10px' }, root: { margin: '0px' }, secondaryText: { fontSize: '8px' }, tertiaryText: { fontSize: '8px' } } }),
                        ...
                        React.createElement(Pagination, { currentPage: 1, totalPages: Math.ceil((this.props.people.length / pageSize)), onChange: function (page) { return _this._getPage(page); }, limiter: 2 })))));
    };
    return PeopleList;
}(React.Component));
export { PeopleList };
